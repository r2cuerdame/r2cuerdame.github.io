...
.deal-landing-hero {
  display: grid; grid-template-columns: minmax(0, 1.05fr) minmax(300px, .62fr); gap: clamp(18px, 3.2vw, 30px);
  align-items: stretch;
...
.deal-hero-copy { padding: 0; background: transparent; border: 0; box-shadow: none; }
.deal-hero-copy h1 { max-width: 720px; margin-top: 8px; margin-bottom: 12px; font-size: clamp(38px, 4.8vw, 56px); letter-spacing: -.055em; }
.deal-hero-copy .lead { max-width: 720px; color: #4b5563; font-size: clamp(16px, 1.7vw, 19px); line-height: 1.62; }
.compact-actions { margin-top: 18px; }
.compact-actions .button { min-height: 44px; border-radius: 14px; }
.deal-flow { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 8px; max-width: 620px; margin-top: 16px; }
...
.affiliate-inline { max-width: 720px; margin: 14px 0 0; color: #6b7280; font-size: 12.5px; line-height: 1.5; font-weight: 750; }
