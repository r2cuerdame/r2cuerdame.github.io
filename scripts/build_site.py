...
.map-node { position: absolute; z-index: 4; display: grid; gap: 5px; justify-items: center; color: #fff; font-size: 12px; font-weight: 950; transform: translate(-50%, -21px); }
...
.map-node em { font-style: normal; padding: 4px 8px; border-radius: 999px; background: rgba(33,25,34,.58); border: 1px solid rgba(255,255,255,.16); backdrop-filter: blur(8px); box-shadow: 0 8px 18px rgba(0,0,0,.18); }
...
@media (max-width: 860px) {
  ...
  .map-node { font-size: 11px; transform: translate(-50%, -19px); }
